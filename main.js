    ...
    get define() {
        return [
            ...
            CoreAsterisk.getOrCreate(
                CoreTerminal.getOrCreate(UserNonTerminal.selector),
                Name.getOrCreate()
            )
        ];
    }
    ...
    get define() {
        return [
            UserOr.getOrCreate(
                ...
                UserGroup.getOrCreate(CoreTerminal.getOrCreate('!'), MyRepeaterSet.getOrCreate())
            )
        ];
    }
    static generateSecondaryParser(bnfAstNode) {
...
class CoreRepeater extends AbstractRepeater {
    ...
    constructor(...args) {
        if(args.length > 1) {
            ...
            args = [UserGroup.getOrCreate(...args)];
        }
        super(...args);
    }
    get Src() {
